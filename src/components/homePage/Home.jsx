    ...
    <Box onClick={handleDrawerToggle} sx={{ textAlign: 'center' }}>
      ...
      <List>
        <div className={style.lateralItems}>
          <a className={style.items} href="#">Home</a>
          <a className={style.items} href="#about">About</a>
          <a className={style.items} href="#skills">Skill</a>
          <a className={style.items} href="#contact">Contact</a>
        </div>
      </List>
    </Box>
  );
